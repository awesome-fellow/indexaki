...
// module
exports.push([module.i, "body {color:black}", ""]);
...
global.jQuery = global.$ = __webpack_require__(14);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../css-loader/index.js!./bootstrap-material-design.min.css", function() {
			var newContent = require("!!../../../css-loader/index.js!./bootstrap-material-design.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
